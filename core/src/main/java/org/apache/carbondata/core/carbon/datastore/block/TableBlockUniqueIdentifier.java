...
public class TableBlockUniqueIdentifier {
  ...
  public String getUniqueTableBlockName() {
    ...
    String uniqueTableBlockName = carbonTableIdentifier.getDatabaseName()
        + CarbonCommonConstants.CARBON_TABLE_COMPONENT_SEPARATOR + carbonTableIdentifier
        .getDatabaseName() + CarbonCommonConstants.CARBON_TABLE_COMPONENT_SEPARATOR
        + this.tableBlockInfo.getSegmentId()
        + CarbonCommonConstants.CARBON_TABLE_COMPONENT_SEPARATOR + blockInfo.hashCode();
