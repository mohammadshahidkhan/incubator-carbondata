...
public class SegmentTaskIndexWrapper implements Cacheable {
   ...
   */
  private Map<String, AbstractIndex> taskIdToTableSegmentMap;
  /**
  ...
  public SegmentTaskIndexWrapper(Map<String, AbstractIndex> taskIdToTableSegmentMap) {
    this.taskIdToTableSegmentMap = taskIdToTableSegmentMap;
  }

  public Map<String, AbstractIndex> getTaskIdToTableSegmentMap() {
    return taskIdToTableSegmentMap;
  }

  public void setTaskIdToTableSegmentMap(Map<String, AbstractIndex> taskIdToTableSegmentMap) {
    this.taskIdToTableSegmentMap = taskIdToTableSegmentMap;
  }
